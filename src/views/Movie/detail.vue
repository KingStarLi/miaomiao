...
.detail_list .detail_list_bg{ width:100%; height:100%; background: url(/images/movie_1.jpg) 0 40%; filter: blur(10px); background-size:cover; position: absolute; left: 0; top: 0;}
...
.detail_player .swiper-slide{ width:98px; margin-right: 20px; text-align: center; font-size: 14px;}
